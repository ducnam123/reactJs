...
const SignInHome = () => {
  ...
  const [user,setUser] = useLocalStorage("user",null) // cách dùng trang hook, tạo có key là user,giá trị mặc định null là chưa có gì

  const navigate = useNavigate() // dùng để chyển trang
