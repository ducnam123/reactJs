...
// phần đăng ký
import * as Yup from 'yup' // giống join nodejs
...
const Signup = () => {
  ...
  }) // register đăng ký các trường trong form, handleSubmit để gửi form đi
      ...
      <div className="max-w-xl lg:max-w-3xl">
        ...
        <form action="#" className="mt-8 grid grid-cols-6 gap-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="col-span-6 sm:col-span-3">
            ...
            />
            <p className="text-[10px] text-red-600">{errors.firstName && errors.firstName.message}</p>
          </div>
